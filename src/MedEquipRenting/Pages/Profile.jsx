            ...
            <div className="md:col-span-3 bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div className="bg-gradient-to-br from-#108de4 to-#0070cc rounded-xl p-6 text-white shadow-md">
                  ...
                  <Link to="/dashboard" className="inline-block px-4 py-2 bg-white text-#0070cc rounded-lg hover:bg-#f0f7ff transition-colors">
                    Go to Dashboard
                  </Link>
                </div>
                
                <div className="bg-gradient-to-br from-#a39991 to-#7d7469 rounded-xl p-6 text-white shadow-md">
                  <h3 className="text-lg font-medium mb-1">Add New Equipment</h3>
                  <p className="text-#f1efee mb-4">Share your medical equipment</p>
                  <Link to="/dashboard?action=add" className="inline-block px-4 py-2 bg-white text-#7d7469 rounded-lg hover:bg-#f9f8f7 transition-colors">
                    Add Equipment
                  </Link>
                </div>
              </div>
